  ...
  switch(state){
    ...
    case "room1":
     ...
     case "lockedGarden" :
       ...
       text("You came across a series of doors.  ",150, 100,600,300);
       text("Press M to start opening them out of curiosity...",150, 150,600,300);

       break;
     case "deadEnd" : 
       println("No Key");
       image (deadEndDoor,0,0);
       text("You end up at a door that's too small for you to fit through. The Doorknob won't let you in without a key.",150, 100,600,300);
       text("Press Z to go back to the hallway.",150, 250,600,300);
       break;
     case "room2":
